...
# The below listings are kept as close as possible to the originals available from the Moby project
# (https://github.com/moby/moby)

# If you open a Pull Request to add names here please open a similar Pull Request at the original code
# repository as well.
...
RIGHT: List[str] = [
	...
	# woman to write a mathematics handbook and the first woman appointed as a Mathematics Professor at a University.
	...
	# the US security space programs. https://en.wikipedia.org/wiki/Wanda_Austin
	"austin",
	...
	# the site of World War II codebreaking - https://en.wikipedia.org/wiki/Sue_Black_(computer_scientist)
	"black",
	...
	# of the mechanisms of smell. https://en.wikipedia.org/wiki/Linda_B._Buck
	"buck",

	# Dame Susan Jocelyn Bell Burnell - Northern Irish astrophysicist who discovered radio pulsars and was the
	# first to analyse them. https://en.wikipedia.org/wiki/Jocelyn_Bell_Burnell
	"burnell",

	# Annie Jump Cannon - pioneering female astronomer who classified hundreds of thousands of stars and created
	# the system we use to understand stars today. https://en.wikipedia.org/wiki/Annie_Jump_Cannon
	"cannon",
	...
	# With Robert Elliot Kahn, he designed TCP and IP, the primary data communication protocols of the
	# Internet and other computer networks. https://en.wikipedia.org/wiki/Vint_Cerf
	"cerf",
	...
	# Taher A. ElGamal - Egyptian cryptographer best known for the ElGamal discrete log cryptosystem and the ElGamal
	# digital signature scheme. https://en.wikipedia.org/wiki/Taher_Elgamal
	"elgamal",
	...
	# scientific truth.  https://en.wikipedia.org/wiki/Galileo_Galilei
	"galileo",

	# Évariste Galois - French mathematician whose work laid the foundations of Galois theory and group theory,
	# two major branches of abstract algebra, and the subfield of Galois connections, all while still in his late teens.
	...
	# western medicine, to graduate in South Asia. https://en.wikipedia.org/wiki/Kadambini_Ganguly
	"ganguly",
	...
	# Caroline Harriet Haslett - English electrical engineer, electricity industry administrator and champion
	# of women's rights. Co-author of British Standard 1363 that specifies AC power plugs and sockets used across
	...
	# popularizing the term "debugging" for fixing computer glitches. https://en.wikipedia.org/wiki/Grace_Hopper
	"hopper",
	...
	# Marie and Pierre Curie. https://en.wikipedia.org/wiki/Ir%C3%A8ne_Joliot-Curie
	"joliot",

	# Karen Spärck Jones came up with the concept of inverse document frequency, which is used in most search
	# engines today. https://en.wikipedia.org/wiki/Karen_Sp%C3%A4rck_Jones
	"jones",
	...
	# scientific TV show, Evident, but Incredible. His father was the Nobel laureate Soviet-era physicist Pyotr Kapitsa,
	# and his brother was the geographer and Antarctic explorer Andrey Kapitsa. -
	...
	# Mstislav Keldysh - a Soviet scientist in the field of mathematics and mechanics, academician of the
	# USSR Academy of Sciences (1946), President of the USSR Academy of Sciences (1961–1975), three times Hero of
	# Socialist Labor (1956, 1961, 1971), fellow of the Royal Society of Edinburgh (1968).
	# https://en.wikipedia.org/wiki/Mstislav_Keldysh
	"keldysh",

	# Mary Kenneth Keller, Sister Mary Kenneth Keller became the first American woman to earn a PhD in
	# Computer Science in 1965. https://en.wikipedia.org/wiki/Mary_Kenneth_Keller
	"keller",
	...
	# CDMA and Bluetooth technology. https://en.wikipedia.org/wiki/Hedy_Lamarr
	"lamarr",
	...
	# and the period of Cepheid variable stars. https://en.wikipedia.org/wiki/Henrietta_Swan_Leavitt
	"leavitt",
	...
	# solid inner core inside a molten outer core. https://en.wikipedia.org/wiki/Inge_Lehmann
	"lehmann",
	...
	# model of the atomic nucleus - https://en.wikipedia.org/wiki/Maria_Mayer
	"mayer",
	...
	# for discovering transposons. https://en.wikipedia.org/wiki/Barbara_McClintock
	"mcclintock",
	...
	# telegraphs and was a co-developer of the Morse code - https://en.wikipedia.org/wiki/Samuel_Morse
	"morse",
	...
	# Panini - Ancient Indian linguist and grammarian from 4th century CE who worked on the world's first
	# formal system - https://en.wikipedia.org/wiki/P%C4%81%E1%B9%87ini#Comparison_with_modern_formal_systems
	"panini",
	...
	# Cecilia Payne-Gaposchkin was an astronomer and astrophysicist who, in 1925, proposed in her Ph.D. thesis
	# an explanation for the composition of stars in terms of the relative abundances of hydrogen and helium.
	...
	# advances the causes of truth and freedom of information by reporting disclosures by whistleblowers such as
	# Edward Snowden. https://en.wikipedia.org/wiki/Laura_Poitras
	"poitras",
	...
	# the pre-Columbian Maya civilization of Mesoamerica. https://en.wikipedia.org/wiki/Tatiana_Proskouriakoff
	"proskuriakova",
	...
	# Soviet biochemist, physiologist and humanist whose medical discoveries saved thousands of lives at the fronts
	# of World War II. She is best known for her pioneering work on blood–brain barrier, which she described as
	...
	# Roberta Williams, did pioneering work in graphical adventure games for personal computers, particularly
	# the King's Quest series. https://en.wikipedia.org/wiki/Roberta_Williams
	"williams",
	...
	# Ada Yonath - an Israeli crystallographer, the first woman from the Middle East to win a Nobel prize in
	# the sciences. https://en.wikipedia.org/wiki/Ada_Yonath
	"yonath",
	...
	# Whereas contemporary scientists scoffed at the idea of human flight, Zhukovsky was the first to undertake the
	# study of airflow. He is often called the Father of Russian Aviation.
